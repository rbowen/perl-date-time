...
is($day, 4, "Rosh Hashanah 2005 is on the 4th");

($month, $day) = roshhashanah(2016);
is($day, 3, "Rosh Hashanah 2016 is on the 3rd");

($month, $day) = roshhashanah(1900);
is($day, 24, "Rosh Hashanah 1900 is on the 24th");

($month, $day) = roshhashanah(1978);
is($day, 2, "Rosh Hashanah 1978 is on the 2nd");

($month, $day) = roshhashanah(2076);
is($day, 28, "Rosh Hashanah 2076 is on the 28th");
